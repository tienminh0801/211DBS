    ...
    return (
        <div class='bg-dark' style={{ height: '780px' }}>
            <main class="cover-container d-flex align-content-center  text-center" style={{ paddingTop: '150px', marginLeft: '150px', border: 'dark' }}>
                ...
                <div class='row'>
                    <div class='m-5 col-6'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="white" class="bi bi-people-fill" viewBox="0 0 16 16">
                    ...
                    <div class='m-5 col-6'>
                        ...
                        <h2 class='text-white mt-4'>Quản lí chi nhánh</h2>
                    </div>
                </div>
            </main>
        </div>

...
export default function AddProduct() {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:5000/san_pham/${location}`)
            .then((res) => {
        ...
        axios
            .get(`http://localhost:5000/hang_san_xuat`)
            .then((res) => {
                ...
                <form class="row g-3 d-flex justify-content-center " method="POST">
                    <div class="col-md-5">
                        ...
                        <input
                            ...
                            class="form-control"
                            id="nameProduct"
                            defaultValue={infoProduct.ten_san_pham}
                            change
                        />
                    </div>
                    <div class="col-md-5">
                        ...
                        <select id="bonusProduct" class="form-select">
                            {infoProduct.ten_san_pham_tang_kem ? (
                                <option selected>{infoProduct.ten_san_pham_tang_kem}</option>
                            ) : (
                                <option selected>Không</option>
                            )}
                            {dataProduct
                                .filter(
                                    (item) => item.ten_san_pham != infoProduct.ten_san_pham_tang_kem
                                )
                                .map((item) => (
                    ...
                    <div class="col-10">
                        ...
                        <input
                            ...
                            class="form-control"
                            id="typeProduct"
                            defaultValue={infoProduct.loai_san_pham}
                        />
                    </div>
                    <div class="col-10">
                        ...
                        <input
                            ...
                            class="form-control"
                            id="material"
                            defaultValue={infoProduct.chat_lieu}
                        />
                    </div>
                    <div class="col-md-10">
                        ...
                        <input
                            ...
                            class="form-control"
                            id="price"
                            defaultValue={infoProduct.gia_niem_yet}
                        />
                    </div>
                    <div class="col-md-10">
                    ...
                    <div class="col-md-10">
                        ...
                        <select id="manufactory" class="form-select">
                            ...
                            {dataFactory
                                .filter((item) => item.ten_hang != infoProduct.ten_hang)
                                .map((item) => (
                    ...
                    <div class="col-md-10">
                        ...
                        <input
                            ...
                            class="form-control"
                            id="guaranteeTime"
                            defaultValue={infoProduct.thoi_gian_bao_hanh}
                        />
                    </div>
                    <div class="col-md-10">
                        ...
                        <input
                            ...
                            class="form-control"
                            id="debutTime"
                            defaultValue={infoProduct.thoi_gian_ra_mat}
                        />
                    </div>
